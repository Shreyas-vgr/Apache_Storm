...
public class SentenceWordCountTopology {
   ...
   * A bolt that counts the words that it receives
   */
  static class SplitSentence extends BaseRichBolt {
    ...
    {
      // tell storm the schema of the output tuple for this spout
      // tuple consists of one word "sentence-word"
  ...
  public static void main(String[] args) throws Exception
  {
    ...
    builder.setBolt("split-sentence-bolt", new SplitSentence(), 15).shuffleGrouping("sentence-spout");
